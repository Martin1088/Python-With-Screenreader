...
dep_employee = db.relationship('Employee', 
back_populates="emp_department", lazy=True)
...
emp_dept_id = db.Column(db.Integer, 
db.ForeignKey('department.dep_id'))
emp_department = db.relationship('Department', 
back_populates="dep_employee", lazy=True)
